...
ca.claim_num, 
ca.created,
-- 2000 chars: for UTF-8/Cyrillic, dbms_lob.substr(..., 4000) often exceeds
-- VARCHAR2 4000-byte SQL limit and raises ORA-06502.
dbms_lob.substr(cea.description_claim, 2000, 1) as description_claim,
sr.act_close_dt,
...
LEFT JOIN siebel.s_srv_req@siebel sr
